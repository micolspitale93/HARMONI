...
class STTDiarizationGoogleService(HarmoniServiceManager):
    """
    Google service
    """
    ...
    def setup_google(self):
        ...
        self.speaker_diarization_config = speech.SpeakerDiarizationConfig(
            enable_speaker_diarization=True,
            min_speaker_count=self.num_speakers,  # Set minimum number of speakers
            max_speaker_count=self.num_speakers,  # Adjust max speakers based on expected number of speakers
        )
        ...
        self.config = speech.RecognitionConfig(
            ...
            max_alternatives=1,
            diarization_config=self.speaker_diarization_config,
    ...
    def listen_print_until_result_is_final(self,responses):
        ...
        for response in responses:
            ...
            for word_info in words_info:
                rospy.loginfo(f"word: '{word_info.word}', speaker_tag: {word_info.speaker_tag}")
...
def main():
    ...
    try:
        ...
        s = STTDiarizationGoogleService(service_id, params)
