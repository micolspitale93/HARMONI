...
def create_root(name= "MicDiarSTT"):

    #microphone=MicrophoneServicePytree("MicrophoneMainActivity")
    diar_stt=DiarSpeechToTextServicePytree("SpeechToTextMainActivity")
    root = py_trees.composites.Sequence(name="MicDiarSTT",memory=False)
    root.add_children([diar_stt])
